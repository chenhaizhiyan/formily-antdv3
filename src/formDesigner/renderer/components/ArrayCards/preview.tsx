import { Card as Card, Row as Row, Col as Col } from 'ant-design-vue'
import { TreeNode, createResource } from '@designable/core'
import { useTreeNode, TreeNodeWidget, DroppableWidget, useNodeIdProps, DnFC } from '@form-designer/prototypes'
import { ArrayBaseMixins, Space } from '@form-designer/components'
                        ...
                        return (
                            <ArrayBase disabled>
                                <ArrayBase.Item index={0} record={null}>
                                    <Card class={cls('antdv-formily-array-cards-item')} title={props.title} {...props} v-slots={{ header: renderHeader }}>
